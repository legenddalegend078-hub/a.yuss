			...
			<div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24">
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
					<AnimatedContainer className="lg:col-span-2 space-y-8">
						<div className="flex items-center gap-3">
							...
							<span className="text-white font-bold text-2xl tracking-tight">Ayush Duwadi</span>
						</div>
						<p className="text-neutral-400 text-base max-w-sm leading-relaxed font-light">
							Building creative digital experiences from Nepal. Cinematic web design, futuristic portfolios, and modern applications.
						</p>
				...
				<AnimatedContainer delay={0.4} className="mt-24 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
					<p className="text-neutral-500 text-sm font-light">
						© 2026 Ayush Duwadi. Designed & Developed in Bharatpur, Chitwan, Nepal.
					</p>
